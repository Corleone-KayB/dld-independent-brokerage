...
Seed these only for development/test environments.

- Super Admin: admin@dldpartners.local
- Compliance Manager: compliance@dldpartners.local
- Sales Manager: sales@dldpartners.local
